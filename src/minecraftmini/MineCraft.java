...
public class MineCraft extends MCWindow {
	...
	protected void init() {
		...
		glFogf(GL_FOG_START, (float)minecraftmini.MCBlock.SIDE * ((LZ-G)*2/3+G) );
		glFogf(GL_FOG_END, (float)minecraftmini.MCBlock.SIDE * (LZ*1.33f));
		glEnable (GL_FOG);*/

		//minecraftmini.MCMaterial.setMaterial( minecraftmini.MCMaterial.NORM );
	...
	public static MCBlock loadBlock(char c, int x, int y, int z) {
		switch (c) {
		case 'g':
			return new MCGrassBlock(x * MCBlock.SIDE, y * MCBlock.SIDE, z * MCBlock.SIDE);
		case 'd':
			return new MCDirtBlock(x * MCBlock.SIDE, y * MCBlock.SIDE, z * MCBlock.SIDE);
		case 'w':
			return new MCWaterBlock(x * MCBlock.SIDE, y * MCBlock.SIDE, z * MCBlock.SIDE);
		case 'o':
			return new MCWoodBlock(x * MCBlock.SIDE, y * MCBlock.SIDE, z * MCBlock.SIDE);
		case 'l':
			return new MCLeavesBlock(x * MCBlock.SIDE, y * MCBlock.SIDE, z * MCBlock.SIDE);
		case 's':
			return new MCSandBlock(x * MCBlock.SIDE, y * MCBlock.SIDE, z * MCBlock.SIDE);
		case 't':
			return new MCStoneBlock(x * MCBlock.SIDE, y * MCBlock.SIDE, z * MCBlock.SIDE);
		}
		return null;
	}
