...
public class MCGridRender{
	...
	public MCGridRender(){
		map = new HashMap<Texture, HashSet<MCTexturedQuad> >();
	}
	...
	public static HashMap< FloatBuffer, ArrayList<MCTexturedQuad> > fadeMap = new HashMap<FloatBuffer, ArrayList<MCTexturedQuad>>();
	static {
		for(FloatBuffer fb : MCMaterial.cache)
			fadeMap.put(fb, new ArrayList<MCTexturedQuad>());
